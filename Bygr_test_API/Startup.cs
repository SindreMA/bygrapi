...
namespace Bygr_test_API
{
    ...
    {
        readonly string _myAllowOrigins = "_myAllowOrigins";
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Bygr_test_API", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseCors(b => b
                 ...
                 .WithOrigins("http://bygrapi.sindrema.com")
                 .WithOrigins("https://bygrapi.sindrema.com")
                 .AllowAnyOrigin()
                 .AllowCredentials()
                 .AllowAnyMethod()
                 .AllowAnyHeader()
